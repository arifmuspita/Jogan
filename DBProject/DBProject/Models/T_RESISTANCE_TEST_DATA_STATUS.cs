...
{
    public class T_RESISTANCE_TEST_DATA_STATUS: T_BASE_TEST_STATUS
    {
        //[Key]
        ...
        //public virtual T_RESISTANCE_TEST_DATA_MASTER T_SIGNAL_TEST_DATA_STATUS_T_RESISTANCE_TEST_DATA_MASTER { get; set; }
