...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.operationParent_ID = "ai.operation.Parent_ID";
        ...
        var TelemetryContext = (function () {
            ...
            TelemetryContext.prototype._applyOperationContext = function (envelope, operationContext) {
                if (operationContext) {
                    ...
                    if (typeof operationContext.Parent_ID === "string") {
                        envelope.tags[tagKeys.operationParent_ID] = operationContext.Parent_ID;
                    }
